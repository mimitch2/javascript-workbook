...
const sumEvens = nums.reduce((sum, even) => {//sum is the accumulator, even is current element in array
  if (even % 2 === 0) {//only find even numbers
    sum += even
  }
